                ...
                <div className="mt-6">
                    ...
                    <div className="mt-6">
                        <a
                            ...
                            className="w-full flex items-center justify-center px-4 py-3 border border-slate-600 rounded-md shadow-sm text-sm font-medium text-white bg-slate-800 hover:bg-slate-700 transition-colors"
                        >
